...
public class InstructorEntity extends GenericEntity {
	...
	@Size(min=5, max=60, message="El nombre es requerido y debe ser mayor que 5 y máximo 60 carácteres")
	...
	@Size(min=8, max=20, message="El nroDocumento es requerido y debe ser mayor que 8 y máximo 20 carácteres")
	@Column(name="NRO_DOCUMENTO", length = 20, nullable = false)
	private String nroDocumento;
	
	
	@Size(min=8, max=20, message="El correo es requerido y debe ser mayor que 8 y máximo 20 carácteres")
	@Column(name="CORREO", length = 20, nullable = false)
	private String correo;
	
	
	@Size(min=8, max=20, message="El telefono es requerido y debe ser mayor que 8 y máximo 20 carácteres")
